...
//        self.ref.child("likeStatuses").child(answerID).observeEventType(.Value, withBlock: { (likeStatusSnapshot) in
...
//                        self.ref.child("likeStatuses/\(currentAnswerID)/\(currentUserID)/likeStatus").setValue(0)
//                        let emptyHeartImage = UIImage(named: "heart-empty")
//                        self.likeButton.setBackgroundImage(emptyHeartImage, forState: .Normal)
//                    }
//                }
